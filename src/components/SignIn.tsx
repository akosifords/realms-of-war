  ...
  return (
    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSignIn} className="flex flex-col mt-[45px]" style={{ alignItems: 'center' }}>
        ...
        <div className="flex flex-col items-center" style={{ marginTop: 'auto', marginBottom: '75px' }}>
          <p 
